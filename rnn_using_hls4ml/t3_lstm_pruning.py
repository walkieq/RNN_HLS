...
pruning_params = {"pruning_schedule" : pruning_schedule.ConstantSparsity(0.5, begin_step=pstep, frequency=100)}
...
if train:
    ...
    model.save('rnn_hls4ml/KERAS_check_best_model.h5')
else:
    model = load_model('rnn_hls4ml/KERAS_check_best_model.h5')
...
hls4ml.report.read_vivado_report('rnn_hls4ml/hls4ml_prj')
